...
function AlertDialogTrigger({ asChild, children, ...props }: AlertDialogTriggerProps) {
  if (asChild && (React.isValidElement(children) || typeof children === "function")) {
    return (
      <AlertDialogPrimitive.Trigger render={children as never} {...props} />
    );
  }
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Backdrop
    ...
    className={cn(
      ...
      "data-[starting-style]:opacity-0 data-[ending-style]:opacity-0 supports-[-webkit-touch-callout:none]:absolute",
      className
    )}
    {...props}
  />
